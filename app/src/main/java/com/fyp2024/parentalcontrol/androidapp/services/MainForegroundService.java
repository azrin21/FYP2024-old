...
import com.fyp2024.parentalcontrol.androidapp.activities.BlockedAppActivity;
import com.fyp2024.parentalcontrol.androidapp.activities.ChildSignedInActivity;
import com.fyp2024.parentalcontrol.androidapp.broadcasts.AppInstalledReceiver;
import com.fyp2024.parentalcontrol.androidapp.broadcasts.AppRemovedReceiver;
import com.fyp2024.parentalcontrol.androidapp.broadcasts.PhoneStateReceiver;
import com.fyp2024.parentalcontrol.androidapp.broadcasts.ScreenTimeReceiver;
import com.fyp2024.parentalcontrol.androidapp.broadcasts.SmsReceiver;
import com.fyp2024.parentalcontrol.androidapp.models.App;
import com.fyp2024.parentalcontrol.androidapp.models.Child;
import com.fyp2024.parentalcontrol.androidapp.models.Contact;
...
public class MainForegroundService extends Service {
	...
	public static final String BLOCKED_APP_NAME_EXTRA = "com.fyp2024.parentalcontrol.androidapp.services.BLOCKED_APP_NAME_EXTRA";
	...
	private void setFence(DataSnapshot dataSnapshot) {
		final com.fyp2024.parentalcontrol.androidapp.models.Location childLocation = dataSnapshot.getValue(com.fyp2024.parentalcontrol.androidapp.models.Location.class);
	...
	private String getLollipopForegroundAppPackageName() {
		...
		try {
			...
			for (UsageStats stats : foregroundApps) {
                /*if (i == 0 && !"com.fyp2024.parentalcontrol.androidapp".equals(stats.getPackageName())) {
